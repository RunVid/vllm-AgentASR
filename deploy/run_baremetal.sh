...
# You can list multiple GPU IDs here, for example: GPUS_TO_USE=(0 1 3)
GPUS_TO_USE=(0)
...
7. **IMPORTANT**: Ensure that port 8443 (for HTTPS) is open in your server's firewall.
   \`sudo ufw allow 8443/tcp\`
...
8. Now, send your API requests from any client using HTTPS and the API key. Example with curl:
   \`curl -X POST -H "X-API-Key: 6a033ce8d2c5346516741b9c38965e633b9a348d0999a31d957141e11d572f57" --insecure -F "files=@/path/to/your/audio.wav" https://8.34.125.71:8443/api/v1/offline_asr\`
